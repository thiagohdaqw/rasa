...
def test_data_convert_help(run: Callable[..., RunResult]):
    ...
    help_text = f"""usage: {RASA_EXECUTABLE} data convert nlu [-h] [-v] [-vv] [--quiet] [-f {{json,yaml}}]
...
def test_data_migrate_help(run: Callable[..., RunResult]):
    ...
    help_text = "usage: {RASA_EXECUTABLE} data migrate [-h] [-v] [-vv] [--quiet] [-d DOMAIN] [--out OUT]"  # noqa: E501
